...
<div class="row row-overflow">
   ...
   <div class="cursor" id="bt_healthwifip" style="background-color : #ffffff; height : 120px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
    <center>
